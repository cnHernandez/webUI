...
export default function HistorialCambioAceiteTab() {
  ...
  return (
    <div className="w-3xl flex items-center justify-center bg-blue-100 py-4">
      <div className="max-w-3xl  mx-auto p-8 bg-white rounded-xl shadow-lg overflow-visible flex flex-col items-center">
        ...
        {historial.length > 0 && (
          <div className="overflow-x-auto max-h-[28vh] overflow-y-auto rounded border border-gray-200 mt-6">
            <table className="w-full border-collapse text-black">
              ...
              <tbody>
                {historial.map((h, i) => (
                  <tr key={i}>
                    <td className="border border-gray-300 p-2 text-center">{h.Fecha ? new Date(h.Fecha).toLocaleDateString() : '-'}</td>
